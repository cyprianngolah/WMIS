CREATE PROCEDURE [dbo].[CollaredAnimal_Update]
	...
	@p_Geofencing NVARCHAR (50) = NULL,
	@p_ReleasedOnSchedule BIT = 0,
	@p_ProgrammingSpec NVARCHAR (MAX) = NULL,
...
AS
	...
	BEGIN
		...
		INSERT INTO CollaredAnimalHerdAssociationHistory (HerdPopulationId, HerdAssociationConfidenceLevelId, HerdAssociationMethodId, HerdAssociationDate, UserId, CollaredAnimalId) VALUES (@p_HerdPopulationId, @p_HerdAssociationConfidenceLevelId, @p_HerdAssociationMethodId, @p_HerdAssociationDate, @p_ChangeBy, @p_CollaredAnimalId)
	END
	...
	SET
		...
		Model = @p_Model,
		Geofencing = @p_Geofencing,
		ReleasedOnSchedule = @p_ReleasedOnSchedule,
		ProgrammingSpec = @p_ProgrammingSpec,
