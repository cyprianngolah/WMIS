...
wmis.rabiestests.upload = (function ($) {
    var bulkUploadDataTable;
    var selectedFile;

    var options = {
        uploadRabiesTestsForm: null
    };
    ...
    function UploadModel() {
        ...
        self.uploadObservationFile = function () {
            ...
            options.uploadRabiesTestsForm.submit();
        };

        self.downloadSelectedFile = function () {
            //wmis.global.showWaitingScreen("Downloading...");
            window.open("/api/rabiestests/uploads/download?fileName=" + selectedFile, '_blank');
        };
    }
    ...
    function initDataTable() {
        ...
        bulkUploadDataTable = $('#bulkUploadTable').dataTable({
            ...
            "bProcessing": true,
            "serverSide": true,
            "ajaxSource": "/api/rabiestests/uploads/",
            ...
            //$('td:eq(3)', row).html('<a href="/api/rabiestests/uploads/download?fileName='+data.fileName+'">Download file</a>');
                    ...
                    if ($(this).hasClass('info')) {
                        ...
                        if (bulkUploadDataTable.$('tr.info').length) {
                            ...
                            if (data.key) {
                                ...
                                //$("#downloadSelectedButton").prop("href", "/api/rabiestests//Edit/" + data.key);
                            }
                        }
                    }
                });
