namespace Wmis.Dto
{
    ...
    public class PagedDataRequest
    {
        ...
        /// <summary>
        /// Gets or sets the secondary column the data was sorted by
        /// </summary>
        public string SubSortBy { get; set; }

        /// <summary>
        /// Gets or sets the direction the Column of data was secondary sorted by
        /// </summary>
        public SortDirection SubSortDirection { get; set; }
        ...
        public PagedDataRequest()
        {
            ...
            SubSortDirection = SortDirection.Desc;
        }
    }
}