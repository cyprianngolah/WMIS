namespace Wmis.ApiControllers
{
    ...
    public class ObservationController : BaseApiController
    {
        ...
        public ObservationController(WebConfiguration config, ObservationParserService observationParserService, Auth.WmisUser user)
            : base(config)
        {
        ...
        {
            Repository.ObservationRowUpdate(observationRow, _user.Username);
        }
    }
}