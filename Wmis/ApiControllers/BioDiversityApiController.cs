    ...
    public class BioDiversityController : BaseApiController
    {
        ...
        public HttpResponseMessage Download([FromUri]BioDiversitySearchRequest sr)
        {
           ...
           // header.CreateCell(3).SetCellValue("SubPhylum");
            ...
            header.CreateCell(4).SetCellValue("Order");
            header.CreateCell(5).SetCellValue("Family");
            header.CreateCell(6).SetCellValue("Common Name");
            header.CreateCell(7).SetCellValue("Name");
            header.CreateCell(8).SetCellValue("Status Rank");
            header.CreateCell(9).SetCellValue("Elcode");
            header.CreateCell(10).SetCellValue("NonNTSpecies");
            header.CreateCell(11).SetCellValue("Canada Known SubSpecies Count");
            header.CreateCell(12).SetCellValue("Canada Known SubSpecies Description");
            header.CreateCell(13).SetCellValue("NWT Known SubSpecies Count");
            header.CreateCell(14).SetCellValue("NWT Known SubSpecies Description");
            header.CreateCell(15).SetCellValue("Age of Maturity");
            ...
            header.CreateCell(19).SetCellValue("Longevity");
            header.CreateCell(20).SetCellValue("Longevity Description");
            header.CreateCell(21).SetCellValue("Vegetation Reproduction Description");
            header.CreateCell(22).SetCellValue("HostFish Description");
            header.CreateCell(23).SetCellValue("Other Reproduction Description");
            header.CreateCell(24).SetCellValue("Ecozone Description");
            header.CreateCell(25).SetCellValue("Ecoregion Description");
            header.CreateCell(26).SetCellValue("Protected Area Description");
            header.CreateCell(27).SetCellValue("Range Extent Score");
            header.CreateCell(28).SetCellValue("Range Extent Description");
            header.CreateCell(29).SetCellValue("Distribution Percentage");
            header.CreateCell(30).SetCellValue("Area Of Occupancy Score");
            header.CreateCell(31).SetCellValue("Area Of Occupancy Description");
            header.CreateCell(32).SetCellValue("Historical Distribution Description");
            header.CreateCell(33).SetCellValue("Marine Distribution Description");
            header.CreateCell(34).SetCellValue("Winter Distribution Description");
            header.CreateCell(35).SetCellValue("Habitat Description");
            header.CreateCell(36).SetCellValue("Environmental Specificity Score");
            header.CreateCell(37).SetCellValue("Environmental Specificity Description");
            header.CreateCell(38).SetCellValue("Population Size Score");
            header.CreateCell(39).SetCellValue("Population Size Description");
            header.CreateCell(40).SetCellValue("Number Of Occurences Score");
            header.CreateCell(41).SetCellValue("Number Of Occurences Description");
            header.CreateCell(42).SetCellValue("Density Description");
            header.CreateCell(43).SetCellValue("Threats Score");
            header.CreateCell(44).SetCellValue("Threats Description");
            header.CreateCell(45).SetCellValue("Intrinsic Vulnerability Score");
            header.CreateCell(46).SetCellValue("Intrinsic Vulnerability Description");
            header.CreateCell(47).SetCellValue("Short Term Trends Score");
            header.CreateCell(48).SetCellValue("Short Term Trends Description");
            header.CreateCell(49).SetCellValue("Long Term Trends Score");
            header.CreateCell(50).SetCellValue("Long Term Trends Description");
            header.CreateCell(51).SetCellValue("Status RankDescription");
            ...
            header.CreateCell(66).SetCellValue("SpeciedId");
            ...
            foreach (var data in lstData.Data)
            {
               ...
               // row.CreateCell(3).SetCellValue(data.SubPhylum.Name);
                row.CreateCell(3).SetCellValue(data.Class.Name);
                row.CreateCell(4).SetCellValue(data.Order.Name);
                row.CreateCell(5).SetCellValue(data.Family.Name);
                row.CreateCell(6).SetCellValue(data.CommonName);
                row.CreateCell(7).SetCellValue(data.Name);
                row.CreateCell(8).SetCellValue(data.StatusRank.Name);
                row.CreateCell(9).SetCellValue(data.Elcode);
                row.CreateCell(10).SetCellValue(data.NonNtSpecies.ToString());
                row.CreateCell(11).SetCellValue(data.CanadaKnownSubSpeciesCount.ToString());
                row.CreateCell(12).SetCellValue(data.CanadaKnownSubSpeciesDescription);
                row.CreateCell(13).SetCellValue(data.NwtKnownSubSpeciesCount.ToString());
                row.CreateCell(14).SetCellValue(data.NwtKnownSubSpeciesDescription);
                row.CreateCell(15).SetCellValue(data.AgeOfMaturity.ToString());
                ...
                row.CreateCell(19).SetCellValue(data.Longevity.ToString());
                row.CreateCell(20).SetCellValue(data.LongevityDescription);
                row.CreateCell(21).SetCellValue(data.VegetationReproductionDescription);
                row.CreateCell(22).SetCellValue(data.HostFishDescription);
                row.CreateCell(23).SetCellValue(data.OtherReproductionDescription);
                row.CreateCell(24).SetCellValue(data.EcozoneDescription);
                row.CreateCell(25).SetCellValue(data.EcoregionDescription);
                row.CreateCell(26).SetCellValue(data.ProtectedAreaDescription);
                row.CreateCell(27).SetCellValue(data.RangeExtentScore);
                row.CreateCell(28).SetCellValue(data.RangeExtentDescription);
                row.CreateCell(29).SetCellValue(data.DistributionPercentage);
                row.CreateCell(30).SetCellValue(data.AreaOfOccupancyScore);
                row.CreateCell(31).SetCellValue(data.AreaOfOccupancyDescription);
                row.CreateCell(32).SetCellValue(data.HistoricalDistributionDescription);
                row.CreateCell(33).SetCellValue(data.MarineDistributionDescription);
                row.CreateCell(34).SetCellValue(data.WinterDistributionDescription);
                row.CreateCell(35).SetCellValue(data.HabitatDescription);
                row.CreateCell(36).SetCellValue(data.EnvironmentalSpecificityScore);
                row.CreateCell(37).SetCellValue(data.EnvironmentalSpecificityDescription);
                row.CreateCell(38).SetCellValue(data.PopulationSizeScore);
                row.CreateCell(39).SetCellValue(data.PopulationSizeDescription);
                row.CreateCell(40).SetCellValue(data.NumberOfOccurencesScore);
                row.CreateCell(41).SetCellValue(data.NumberOfOccurencesDescription);
                row.CreateCell(42).SetCellValue(data.DensityDescription);
                row.CreateCell(43).SetCellValue(data.ThreatsScore);
                row.CreateCell(44).SetCellValue(data.ThreatsDescription);
                row.CreateCell(45).SetCellValue(data.IntrinsicVulnerabilityScore);
                row.CreateCell(46).SetCellValue(data.IntrinsicVulnerabilityDescription);
                row.CreateCell(47).SetCellValue(data.ShortTermTrendsScore);
                row.CreateCell(48).SetCellValue(data.ShortTermTrendsDescription);
                row.CreateCell(49).SetCellValue(data.LongTermTrendsScore);
                row.CreateCell(50).SetCellValue(data.LongTermTrendsDescription);
                row.CreateCell(51).SetCellValue(data.StatusRankDescription);
                ...
                row.CreateCell(66).SetCellValue(data.Key);
